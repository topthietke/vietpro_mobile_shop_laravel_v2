                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="mail_host" required class="form-control" value="........" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Mail Username</label>
                                <input type="text" name="mail_username" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Mail Password</label>
                                <input type="password" name="mail_password" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Mail stmpsecure</label>
                                <input type="text" name="mail_smtpsecure" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>TCP port</label>
                                <input type="text" name="mail_port" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>setFrom</label>
                                <input type="text" name="mail_setform" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>setAddcc</label>
                                <input type="text" name="mail_addcc" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Subject</label>
                                <input type="text" name="mail_subject" required  value="........" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Altbody</label>
                                <input type="text" name="mail_altbody" required  value="........" class="form-control">
                            </div>
